...
const Navbar = () => {
  ...
  return (
    <div className=" flex justify-between items-center p-4 bg-white sticky top-0 left-0 w-full z-[9] max-md:justify-start max-md:flex max-md:items-start max-sm:flex-col max-sm:justify-start max-sm:items-start max-lg:pl-[50px]">
      {showSearch ? (
