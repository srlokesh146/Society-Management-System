    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-[9999]">
            <div className="bg-white p-6 shadow-lg relative w-[410px] rounded-[15px]">
                <h2 className="text-lg font-semibold mb-[10px]">Details of the Per Person</h2>
                ...
                <div className="mb-[20px]">
                    <label htmlFor="select-members" className="block text-[14px] leading-[21px] font-medium mb-[5px] text-[#202224]">
                        Select Members
                    </label>
                    <select
                        id="select-members"
