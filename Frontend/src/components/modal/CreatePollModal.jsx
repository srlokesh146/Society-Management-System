  ...
  return (
    <div className='fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-[9999]'>
      <div className='bg-white p-6 rounded-lg w-[410px] relative'>
        ...
        <div className='mb-4'>
          <label className='block mb-2 text-[14px] leading-[21px] font-medium'>Poll Type</label>
              ...
              <span className={pollType ? 'text-black' : 'text-[#A7A7A7]'}>
                <div className='text-[14px] leading-[21px] font-normal flex'>
                  <img
                    ...
                    alt='handPollImage'
                    className={pollType ? 'w-4 h-4 mr-2 filter-grayscale' : "filter-none"}
                  />
        ...
        <div className='flex justify-between mt-[32px]'>
          ...
          <button
            ...
            className={`w-full py-[13.5px] font-semibold px-4 rounded-[10px] 
              ${
                isFormValid ? 'bg-custom-gradient text-white' : 'bg-[#F6F8FB] text-black'
              }`}
          >
            Create
          </button>
