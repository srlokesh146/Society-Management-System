    ...
    <div className="h-screen flex overflow-hidden bg-gray-100">
      ...
      >
        {shouldRenderSidebarAndNavbar && (
          ...
          <div className={`flex-1 ${shouldRenderSidebarAndNavbar ? "p-6 max-sm:p-4 max-md:overflow-auto" : "overflow-auto  max-md:overflow-auto max-lg:overflow-auto max-xl:overflow-y-auto"} bg-gray-100 overflow-auto max-md:overflow-auto max-lg:overflow-auto max-xl:overflow-auto`}>
