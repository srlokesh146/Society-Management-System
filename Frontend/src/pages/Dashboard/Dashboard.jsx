...
import { pendingMaintenances, cardData } from "../../constantdata";
  ...
  const cardData = [
    {
      ...
      bgColor: "#F9F9F9", // Light background color for the card.
      gradient:
        "linear-gradient(255.6deg, #FF6A00 7.71%, rgba(255, 255, 255, 0) 18.54%)", // Used for the border effect.
      borderRadius: "12px", // For rounded corners.
      boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)", // Subtle shadow effect.
      iconBg: "#FFE6D5", // Icon background matching the screenshot.
      icon: icon1, // Use the correct icon variable.
      iconColor: "#FF6A00", // For the icon text color.
      afterStyle: {
        content: '""',
        position: "absolute",
        top: 0,
        ...
        width: "40px",
        height: "40px",
        backgroundColor: "#FF6A00", // Corner accent color.
        borderRadius: "0 12px 0 40px", // Matches the curved effect.
      },
    },
    ...
    <div className="flex h-screen bg-gray-100">
      <main className="flex-1">
        <div>
          ...
          <div className="grid grid-cols-3 max-2xl:grid-cols-1 gap-3 mt-[20px] max-xl:grid-cols-1 max-sm:grid-col-1">
