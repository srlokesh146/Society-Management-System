...
function ResidentSecurityProtocol() {
    const data = [
        { title: "Cameron Williamson", description: "A visual representation your spending categories.", date: "11/02/2024", time: "2:45 PM" },
        ...
        { title: "Esther Howard", description: "A visual representation your spending categories.", date: "21/02/2024", time: "9:45 PM" },
    ];
    return (
        <div >
                        ...
                        {data.map((item, index) => (
                            ...
                            >
                                ...
                                <td className="px- py-4">
                                    <p className='bg-gray-50 p-2 text-center w-20 rounded-full'>{item.time}</p>
                                </td>
                            </tr>
                        ))}
                    </tbody>
