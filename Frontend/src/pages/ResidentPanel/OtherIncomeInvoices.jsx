...
const data = [
    {
        ...
        description: "Navratri is a major Hindu festival celebrated for nine nights, honoring Goddess Durga.", 
    },
    {
        id: 2,
        title: "Due Event Payment",
        ...
        <div>
            <div className="bg-white p-6 mt-6 rounded-lg shadow-sm">
                ...
                <div className="grid grid-cols-1 mt-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    {data.map((invoice) => (
                        <div key={invoice.id} className="border border-grey-800 rounded-lg">
                            <div className="bg-[#5678E9] text-white p-4 flex justify-between items-center rounded-t-lg">
                                <h2 className="text-sm sm:text-base font-semibold">{invoice.title}</h2>
                            ...
                            <div className="p-4">
                                <div className="space-y-2">
                                    <div className="flex justify-between items-center text-sm sm:text-base text-gray-600">
                                        ...
                                        <p className="text-gray-400">{invoice.eventname}</p>
                                    </div>
                                    <div className="flex justify-between items-center text-sm sm:text-base text-gray-600">
                                        <span className="font-sm">Due Date</span>
                                        <p className="text-gray-400 text-[15px]">{invoice.eventduedate}</p>
                                    </div>
                                    <div className="flex justify-between items-center text-sm sm:text-base text-gray-600">
                                        <span className="font-sm">Amount</span>
                                        <p className="text-red-500">{invoice.amount}</p>
                                    </div>
                                    <button 
                                      onClick={handleOtherInvoices}
                    ...
                    <div className="bg-white w-10/12 sm:w-[28rem] max-h-[90vh] overflow-y-auto p-6 rounded-lg shadow-lg">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-gray-100 rounded-lg">
                                ...
                                <p >
                                        <strong className="text-gray-400 font-normal">Event Date:</strong>
                                ...
                                <div className="p-2">
                                    ...
                                    <p className="mt-2">
                                        <strong className="text-gray-400 font-normal">Event Name</strong>
                                        <p>{selectedInvoice.eventname}</p>
                                    </p>
                                    <p className="mt-2">
                                        <strong className="text-gray-400 font-normal">Description</strong>
