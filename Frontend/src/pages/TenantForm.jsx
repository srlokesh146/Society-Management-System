...
export default function OwnerForm() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F8F8] p-4">
      ...
      {/* Owner Details Section - New Addition */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <input
              ...
              placeholder="Enter Full Name"
              className="w-full h-[42px] px-4 border border-[#E8E8E8] rounded-[4px] text-sm 
              placeholder:text-[#ADADAD] focus:outline-none focus:border-black transition-colors duration-200"
            />
          </div>
